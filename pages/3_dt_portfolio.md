...
Extremes-DT:
* IFS cycle CY48r3.1: scientifically equivalent to CY48r1, it has been updated to run at higher resolution (TCo2559) on the LUMI HPC, using GPUs to run the spectral transforms, and writing output fields in GRIB 2 only <!--TODO check if this is only valid for extremes dt! -->
